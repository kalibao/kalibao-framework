...
--
-- Client :  localhost
-- Généré le :  Dim 12 Avril 2015 à 09:41
...
`id` bigint(20) unsigned NOT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=660 ;
...
(244, 1, 'modal_remove_selected', '2013-04-25 10:00:05', '2014-07-19 08:06:05'),
(245, 1, 'modal_remove_one', '2013-04-25 10:12:21', '2014-06-19 07:59:18'),
...
(485, 2, 'btn_view_photos', '2014-07-21 12:46:01', '2014-07-25 09:42:23'),
...
(650, 1, 'variable:name', '2015-04-12 06:00:04', '2015-04-12 06:00:04'),
(651, 1, 'variable:val', '2015-04-12 06:00:20', '2015-04-12 06:00:20'),
(652, 1, 'variable_group:code', '2015-04-12 06:03:59', '2015-04-12 06:03:59'),
(654, 1, 'generator_position', '2015-04-16 00:18:52', '2015-04-16 00:18:52'),
(655, 1, 'generator_column', '2015-04-16 00:22:20', '2015-04-16 00:22:20'),
(656, 1, 'generator_table', '2015-04-16 00:22:33', '2015-04-16 00:22:33'),
(657, 1, 'generator_type', '2015-04-16 00:23:34', '2015-04-16 00:23:34'),
(658, 1, 'generator_option', '2015-04-16 00:42:10', '2015-04-16 00:42:10'),
(659, 1, 'generator_related_column_displayed', '2015-04-16 00:42:35', '2015-04-16 00:42:35');
...
INSERT INTO `person` (`id`, `first_name`, `last_name`, `email`, `default_language`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 'Super', 'Admin', 'admin@kalibao.com', 'fr', 1, '0000-00-00 00:00:00', '2015-04-12 07:39:58'),
(2, 'no-reply', '(kalibao.com)', 'noreply@kalibao.com', 'fr', 2, '2015-03-18 05:56:33', '2015-04-12 05:40:43');
...
ALTER TABLE `cms_image`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `file_path` (`file_path`), ADD KEY `cms_image_group_id` (`cms_image_group_id`);
...
ALTER TABLE `cms_image_group_i18n`
 ADD PRIMARY KEY (`cms_image_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_image_i18n`
--
ALTER TABLE `cms_image_i18n`
 ADD PRIMARY KEY (`cms_image_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);
...
ALTER TABLE `cms_layout_i18n`
 ADD PRIMARY KEY (`cms_layout_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_news`
--
ALTER TABLE `cms_news`
 ADD PRIMARY KEY (`id`), ADD KEY `cms_news_group_id` (`cms_news_group_id`);
...
ALTER TABLE `cms_news_group_i18n`
 ADD PRIMARY KEY (`cms_news_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_news_i18n`
--
ALTER TABLE `cms_news_i18n`
 ADD PRIMARY KEY (`cms_news_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_page`
--
ALTER TABLE `cms_page`
 ADD PRIMARY KEY (`id`), ADD KEY `cms_layout_id` (`cms_layout_id`);

--
-- Index pour la table `cms_page_content`
--
ALTER TABLE `cms_page_content`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `cms_page_id_2` (`cms_page_id`,`index`), ADD KEY `cms_page_id` (`cms_page_id`);

--
-- Index pour la table `cms_page_content_i18n`
--
ALTER TABLE `cms_page_content_i18n`
 ADD PRIMARY KEY (`cms_page_content_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_page_i18n`
--
ALTER TABLE `cms_page_i18n`
 ADD PRIMARY KEY (`cms_page_id`,`i18n_id`), ADD UNIQUE KEY `language_2` (`i18n_id`,`slug`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_simple_menu`
--
ALTER TABLE `cms_simple_menu`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `position` (`position`,`cms_simple_menu_group_id`), ADD KEY `cms_simple_menu_group_id` (`cms_simple_menu_group_id`);
...
ALTER TABLE `cms_simple_menu_group_i18n`
 ADD PRIMARY KEY (`cms_simple_menu_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_simple_menu_i18n`
--
ALTER TABLE `cms_simple_menu_i18n`
 ADD PRIMARY KEY (`cms_simple_menu_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);
...
ALTER TABLE `cms_social_i18n`
 ADD PRIMARY KEY (`cms_social_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_widget`
--
ALTER TABLE `cms_widget`
 ADD PRIMARY KEY (`id`), ADD KEY `cms_widget_group_id` (`cms_widget_group_id`);
...
ALTER TABLE `cms_widget_group_i18n`
 ADD PRIMARY KEY (`cms_widget_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `cms_widget_i18n`
--
ALTER TABLE `cms_widget_i18n`
 ADD PRIMARY KEY (`cms_widget_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `interface_setting`
--
ALTER TABLE `interface_setting`
 ADD PRIMARY KEY (`interface_id`,`user_id`), ADD KEY `person_id` (`user_id`);
...
ALTER TABLE `language_group_i18n`
 ADD PRIMARY KEY (`language_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `language_group_language`
--
ALTER TABLE `language_group_language`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `language_group_id_2` (`language_group_id`,`language_id`), ADD KEY `language_id` (`language_id`);

--
-- Index pour la table `language_i18n`
--
ALTER TABLE `language_i18n`
 ADD PRIMARY KEY (`language_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `mail_sending_role`
--
ALTER TABLE `mail_sending_role`
 ADD PRIMARY KEY (`person_id`,`mail_template_id`,`mail_send_role_id`), ADD KEY `mail_template_id` (`mail_template_id`), ADD KEY `mail_send_role_id` (`mail_send_role_id`);
...
ALTER TABLE `mail_send_role_i18n`
 ADD PRIMARY KEY (`mail_send_role_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `mail_template`
--
ALTER TABLE `mail_template`
 ADD PRIMARY KEY (`id`), ADD KEY `mail_template_type_id` (`mail_template_group_id`);
...
ALTER TABLE `mail_template_group_i18n`
 ADD PRIMARY KEY (`mail_template_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `mail_template_i18n`
--
ALTER TABLE `mail_template_i18n`
 ADD PRIMARY KEY (`mail_template_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `message`
--
ALTER TABLE `message`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `message_category_id` (`message_group_id`,`source`), ADD KEY `category_id` (`message_group_id`);
...
ALTER TABLE `message_group_i18n`
 ADD PRIMARY KEY (`message_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `message_i18n`
--
ALTER TABLE `message_i18n`
 ADD PRIMARY KEY (`message_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `person`
--
ALTER TABLE `person`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `email` (`email`), ADD KEY `default_language` (`default_language`), ADD KEY `user_id` (`user_id`);
...
ALTER TABLE `rbac_permission_i18n`
 ADD PRIMARY KEY (`rbac_permission_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);
...
ALTER TABLE `rbac_role_i18n`
 ADD PRIMARY KEY (`rbac_role_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `rbac_role_permission`
--
ALTER TABLE `rbac_role_permission`
 ADD PRIMARY KEY (`rbac_role_id`,`rbac_permission_id`), ADD KEY `rbac_permission_id` (`rbac_permission_id`);

--
-- Index pour la table `rbac_user_role`
--
ALTER TABLE `rbac_user_role`
 ADD PRIMARY KEY (`user_id`,`rbac_role_id`), ADD KEY `rbac_role_id` (`rbac_role_id`);

--
-- Index pour la table `user`
--
ALTER TABLE `user`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `email` (`username`);

--
-- Index pour la table `variable`
--
ALTER TABLE `variable`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `unique_param` (`variable_group_id`,`name`);
...
ALTER TABLE `variable_group_i18n`
 ADD PRIMARY KEY (`variable_group_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);

--
-- Index pour la table `variable_i18n`
--
ALTER TABLE `variable_i18n`
 ADD PRIMARY KEY (`variable_id`,`i18n_id`), ADD KEY `i18n_id` (`i18n_id`);
...
--
ALTER TABLE `language_group_i18n`
MODIFY `language_group_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
ADD CONSTRAINT `mail_sending_role_ibfk_7` FOREIGN KEY (`person_id`) REFERENCES `person` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
